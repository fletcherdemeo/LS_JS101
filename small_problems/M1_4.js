...
// stack) and a register value of 7, the MULT operation mutates the stack to
// [3, 6] (the 4 is removed), and the result of the multiplication, 28, is left
// in the register. If we do another MULT at this point, the stack is mutated to
...
//             popped stack value, storing the integer remainder of the division
...
// they will not do anything like trying to pop a non-existent value from the 
// stack, and they won't contain any unknown tokens.

// Initialize the stack and register to the values [] and 0, respectively.

// Algorithm
// 1. Split string argument and assign to args array
// 2. Loop through args array
//    - if arg is a number
//      - add arg to register
//    - if arg === PUSH
//      - push value onto stack array
//      - leave value in register
//    - if arg === ADD
//      - pop value from stack and add to register value
//      - store result as register value
//    - if arg === SUB
//      - pop value from stack and subtract from register value
//      - store result as register value
//    - if arg === MULT
//      - pop value from stack and multiply it by register value
//      - store result as register value
//    - if arg === DIV
//      - pop value from stack and divide it by register value
//      - store result as register value
//    - if arg === REMAINDER
//      - pop value from stack and divide register value by popped value
//      - store integer remainder value as register value
//    - if arg === POP
//      - pop value from stack
//      - store as register value
//    - if arg === PRINT
//      - log register value

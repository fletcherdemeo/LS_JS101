...
// Algorithm
// 1. Split input string on characters .!? into array
// 2. Loop through array and find the longest sentence - string length
// 3. Return the sentence with the longest string length
